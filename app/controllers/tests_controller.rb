class TestsController < ApplicationController
  ...
  def correctuser
    ...
    redirect_to tests_path, notice: "he is no authorized to edit this tester!!" if @test.nil?
  end
  ...
  private
    ...
    def test_params
      params.require(:test).permit(:first_name, :last_name, :email, :phone, :occupation, :user_id)
    end
end
